...
class owner {
	...
	function __construct(){
		...
		randomVehicle($randomFloat);
	}
	
	function randomVehicle($vehicleNum){
		if($vehicleNum <= 0.22if($vehicleNum<=0.228375944) { //Chevrolet Volt
		...
		elseif(($vehicleNum>0.869882917)&&($vehicleNum<=0.919608955)) { //BMW i3
			...
			$this->chargeTime = 4;
			$this->battSize = 22;
			$this->maxMilesEV = 118; // Confirm these numbers with Eliot
			$this->maxMilesPH = 205;
		}
